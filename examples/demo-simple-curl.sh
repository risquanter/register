#!/usr/bin/env bash
# =============================================================================
# demo-simple-curl.sh — Operational Risk Model demo (curl)
#
...
# Requires: curl, jq
#
# Usage:  ./examples/demo-simple-curl.sh [base_url]
...
header "Demo: Operational Risk Model (curl)"
info "Server: $BASE"
...
curl -s -H "X-Branch: main" "$BASE/w/$WS_KEY/risk-trees/$TREE_ID" | jq .
