...
For JWT claims parsing, UserContext extraction, and Keycloak integration patterns, consult the **Cheleb reference architecture** as initial design guidance.

**Before implementing:**
1. Review Cheleb patterns for ZIO + OAuth2 integration
...
- Cheleb Reference Architecture: (consult for ZIO + OAuth2 patterns)
