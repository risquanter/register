...
> milestone-2b decision log (`docs/archive/plans/milestone-2b-cache-and-decisions.md`).
...
- `docs/archive/plans/milestone-2b-cache-and-decisions.md` — decision log (DD-5, DD-7, DD-8, DD-15…DD-19, DD-21, DD-22)
