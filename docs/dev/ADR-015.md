...
> See `docs/scratch/milestone-2b-cache-and-decisions.md` (DD-14…DD-20).
...
- A `RiskResultResolver` abstraction — `ensureCached(nodeId)` — decouples cache-miss handling from the cache's storage contract, allowing either one to evolve independently
