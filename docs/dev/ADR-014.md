...
// GOOD: Cache-aside via CachedResultResolver, query methods are pure transforms
...
- **`CachedResultResolver`**: Service with `ensureCached(tree, nodeId)` primitive
...
- [ADR-015.md](./ADR-015.md) — Cache Integration: CachedResultResolver pattern
